...
namespace Hitwicket.DoTweenTimeline
{
    ...
    public class DoTweenMoveBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            if (isLocal)
                return target.transform.DOLocalMove(endValue, duration).SetEase(easeType);
            else
                return target.transform.DOMove(endValue, duration).SetEase(easeType);
        }
    ...
    public class DoTweenRotateBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            if (target == null) return null;
            if (isLocal)
                return target.transform.DOLocalRotate(endValue, duration, rotateMode).SetEase(easeType);
            else
                return target.transform.DORotate(endValue, duration, rotateMode).SetEase(easeType);
        }
    ...
    public class DoTweenScaleBlock : DoTweenBlock
    {
        ...
        {
            if (target == null) return null;
            return target.transform.DOScale(endValue, duration).SetEase(easeType);
        }
    ...
    public class DoTweenFadeBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            if (graphic != null)
                return graphic.DOFade(endValue, duration).SetEase(easeType);

            var spriteRenderer = target.GetComponent<SpriteRenderer>();
            if (spriteRenderer != null)
                return spriteRenderer.DOFade(endValue, duration).SetEase(easeType);
    ...
    public class DoTweenColorBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            var graphic = target.GetComponent<Graphic>();
            if (graphic != null)
                return graphic.DOColor(endValue, duration).SetEase(easeType);

            var spriteRenderer = target.GetComponent<SpriteRenderer>();
            if (spriteRenderer != null)
                return spriteRenderer.DOColor(endValue, duration).SetEase(easeType);
    ...
    public class DoTweenAnchorPosBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            if (rectTransform != null)
                return rectTransform.DOAnchorPos(endValue, duration).SetEase(easeType);
    ...
    public class DoTweenSizeDeltaBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            var rectTransform = target.GetComponent<RectTransform>();
            if (rectTransform != null)
                return rectTransform.DOSizeDelta(endValue, duration).SetEase(easeType);
        ...
        public override Tween GenerateTween()
        {
            ...
            if (image != null)
            {
                if (image.type != Image.Type.Filled)
                    image.type = Image.Type.Filled; // Auto-fix to filled type
                    
                return image.DOFillAmount(endValue, duration).SetEase(easeType);
            }
    ...
    public class DoTweenTextBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            if (text != null)
                return text.DOText(endValue, duration, richTextEnabled, scrambleMode).SetEase(easeType);
    ...
    public class DoTweenAnchorMinBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            var rectTransform = target.GetComponent<RectTransform>();
            if (rectTransform != null)
                return rectTransform.DOAnchorMin(endValue, duration).SetEase(easeType);
    ...
    public class DoTweenAnchorMaxBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            var rectTransform = target.GetComponent<RectTransform>();
            if (rectTransform != null)
                return rectTransform.DOAnchorMax(endValue, duration).SetEase(easeType);
    ...
    public class DoTweenPivotBlock : DoTweenBlock
    {
        ...
        public override Tween GenerateTween()
        {
            ...
            var rectTransform = target.GetComponent<RectTransform>();
            if (rectTransform != null)
                return rectTransform.DOPivot(endValue, duration).SetEase(easeType);
